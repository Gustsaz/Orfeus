...
class VirtualPiano {
  ...
  createPianoKeys() {
    ...
    whiteKeys.forEach((note, index) => {
      ...
      key.dataset.frequency = this.getFrequency(note, 4);
      key.addEventListener('mousedown', (e) => this.playNote(e.target.dataset.frequency, e.target));
...
// Instanciar piano virtual
let virtualPiano = null;
