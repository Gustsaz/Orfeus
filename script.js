...
window.addEventListener("mouseup", () => {
  ...
  if (targetBtn) {
    ...
    if (card) { card.classList.add("front"); openCardSequentially(card); }

    // move disco + seta + botões para a ESQUERDA (sem mexer no transform base)
    // move disco + seta + botões + tonearm para a ESQUERDA
